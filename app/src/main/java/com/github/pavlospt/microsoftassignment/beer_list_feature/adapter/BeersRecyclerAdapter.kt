package com.github.pavlospt.microsoftassignment.beer_list_feature.adapter
...
import com.github.pavlospt.microsoftassignment.beer_list_feature.adapter.BeersRecyclerAdapter.BeerViewHolder
  ...
  inner class BeerViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    fun bind(beer: BeerModel) {
      ...
      Glide
          ...
          .load(beer.imageUrl)
          .error(ContextCompat.getDrawable(itemView.context, R.mipmap.ic_beer))
          .into(beerImage)
    }
